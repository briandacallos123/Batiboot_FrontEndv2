...
import { getAllUsersRole } from '../../../redux/slices/adminUserRole';
...
import { UserTableToolbar, UserTableRow, UserRoleTableRow } from '../../../sections/@batiboot/user/user&role';
...
export default function UserRoles() {
  ...
  const { usersRole, totalData, ccc, usersRoleArr, isLoading } = useSelector((state) => state.adminUserRole);
...
console.log("filter servies", filterService);
  ...
  useEffect(async() => {
    ...
    await dispatch(getAllUsersRole(payload));
  ...
  setStatus(type);
    ...
    payload.startDate = filterStartDate;
    payload.endDate = filterEndDate;
    dispatch(getAllUsersRole(payload));
