...
import { ServiceRebrandingGallery, ServiceRebrandingSlider } from '.';
...
export default function ServiceRebranding(props) {
        ...
        <Grid item xs={12}>
          <m.div variants={varFade().inRight}>
            <Typography variant="h4" sx={{ mt: 2 }}>
              {loading ? <Skeleton /> : 'PRODUCT REBRANDING'}
            </Typography>
          </m.div>
        </Grid>
        <Grid item md={10}>
          ...
          ducimus voluptates voluptas?`
            ...
            <Grid container direction="row" alignItems="center" sx={{ mt: 2 }}>
              ...
              <Button
                ...
                variant="outlined"
                onClick={handleOpen}
                sx={{ ml: 1, border: 1, background: 'rgba(0, 0, 0, 0.05)' }}
              >
                Learn More
              </Button>
              <Modal
