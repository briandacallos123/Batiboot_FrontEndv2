import { Grid, Card, Button, Typography, DialogActions, Box, Stack, styled } from '@mui/material';
  ...
  return (
    <Card>
      <Stack sx={{ py: 2, px: 3 }}>
        ...
        <Box>
          <PopUpModal open={openModal} onClose={handleCloseModal} isIdentifier={identifier} nameLink={'Quotation'} />
        </Box>
        <div>
